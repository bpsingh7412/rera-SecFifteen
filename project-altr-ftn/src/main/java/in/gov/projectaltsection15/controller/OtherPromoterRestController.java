...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/project_alt_ftn/secure/section15/other-promoter")
public class OtherPromoterRestController {
	private static final Logger logger = LogManager.getLogger(OtherPromoterRestController.class);
	@Autowired
	...
	public ResponseEntity<?> getStageOneByAlterationId(@PathVariable (value="id") Long id){		
		AuthorizedSignatoryDtlModel lm=services.getByStageTwoId(id);
